...
//   - app/routes/_renderer.tsx は filesystem routing 規約の "薄い橋渡し"
//
// この re-export pattern なら、layout component の物理配置を変えても app/routes/_renderer.tsx
// の import path を 1 行直すだけで済む = filesystem 規約と domain folder 哲学の両立。

export { AppLayout as default } from "../../src/layouts/AppLayout.tsx";
